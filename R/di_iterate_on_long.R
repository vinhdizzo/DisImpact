...
##' @param cohort_var_col (Optional) A character value corresponding to the variable or column name in \code{data} that stores the cohort label for the data described in each row.
