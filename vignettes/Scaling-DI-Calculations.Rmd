...
![plot of chunk no_disagg](figure/no_disagg-1.png)
...
![plot of chunk disagg_ethnicity](figure/disagg_ethnicity-1.png)
...
![plot of chunk disagg_ethnicity-deg_transf](figure/disagg_ethnicity-deg_transf-1.png)
...
![plot of chunk disagg_gender-deg_transf_eng](figure/disagg_gender-deg_transf_eng-1.png)
...
```
##        Ed_Goal     College_Status   college success_variable cohort_variable
## 1 Deg/Transfer First-time College College 1             Math     Cohort_Math
## 2 Deg/Transfer First-time College College 1             Math     Cohort_Math
## 3 Deg/Transfer First-time College College 1             Math     Cohort_Math
## 4 Deg/Transfer First-time College College 1             Math     Cohort_Math
## 5 Deg/Transfer First-time College College 1             Math     Cohort_Math
## 6 Deg/Transfer First-time College College 1             Math     Cohort_Math
##   cohort disaggregation           group   n success       pct ppg_reference
## 1   2017      Ethnicity           Asian 776     692 0.8917526     0.8427699
## 2   2017      Ethnicity           Black 235     185 0.7872340     0.8427699
## 3   2017      Ethnicity        Hispanic 474     347 0.7320675     0.8427699
## 4   2017      Ethnicity Multi-Ethnicity 117      99 0.8461538     0.8427699
## 5   2017      Ethnicity Native American  30      28 0.9333333     0.8427699
## 6   2017      Ethnicity           White 823     718 0.8724180     0.8427699
##   ppg_reference_group        moe    pct_lo    pct_hi di_indicator_ppg
## 1             overall 0.03517995 0.8565726 0.9269325                0
## 2             overall 0.06392815 0.7233059 0.8511622                0
## 3             overall 0.04501289 0.6870546 0.7770804                1
...
```
## Warning: package 'data.table' was built under R version 4.3.0
```

```
## data.table 1.14.3 IN DEVELOPMENT built 2022-07-20 18:26:12 UTC; root using 6 threads (see ?getDTthreads).  Latest news: r-datatable.com
## **********
...
```r
# Results stored as a data.table
results_dt
```
...
##      1:             Math     Cohort_Math   2017      Ethnicity           Asian
##      2:             Math     Cohort_Math   2017      Ethnicity           Black
##      3:             Math     Cohort_Math   2017      Ethnicity        Hispanic
##      4:             Math     Cohort_Math   2017      Ethnicity Multi-Ethnicity
##      5:             Math     Cohort_Math   2017      Ethnicity Native American
##     ---                                                                       
## 180494:         Transfer          Cohort   2018         - None           - All
## 180495:         Transfer          Cohort   2017         - None           - All
## 180496:         Transfer          Cohort   2018         - None           - All
## 180497:         Transfer          Cohort   2017         - None           - All
## 180498:         Transfer          Cohort   2018         - None           - All
##               n success        pct ppg_reference ppg_reference_group        moe
##           <int>   <num>      <num>         <num>              <char>      <num>
##      1:     776      24 0.03092784    0.05336049             overall 0.03517995
##      2:     235      24 0.10212766    0.05336049             overall 0.06392815
##      3:     474      25 0.05274262    0.05336049             overall 0.04501289
##      4:     117      17 0.14529915    0.05336049             overall 0.09060103
##      5:      30      14 0.46666667    0.05336049             overall 0.17892270
##     ---                                                                        
## 180494:   10000     404 0.04040000    0.04040000             overall 0.03000000
## 180495:   10000     391 0.03910000    0.03910000             overall 0.03000000
## 180496:   10000     404 0.04040000    0.04040000             overall 0.03000000
## 180497: 2000000   78200 0.03910000    0.03910000             overall 0.03000000
## 180498: 2000000   80800 0.04040000    0.04040000             overall 0.03000000
##               pct_lo     pct_hi di_indicator_ppg success_needed_not_di_ppg
##                <num>      <num>            <num>                     <num>
##      1: -0.004252115 0.06610778                0                         0
##      2:  0.038199508 0.16605581                0                         0
##      3:  0.007729725 0.09775551                0                         0
##      4:  0.054698113 0.23590018                0                         0
##      5:  0.287743965 0.64558937                0                         0
##     ---                                                                   
## 180494:  0.010400000 0.07040000                0                         0
## 180495:  0.009100000 0.06910000                0                         0
## 180496:  0.010400000 0.07040000                0                         0
## 180497:  0.009100000 0.06910000                0                         0
## 180498:  0.010400000 0.07040000                0                         0
##         success_needed_full_parity_ppg di_prop_index di_indicator_prop_index
##                                  <num>         <num>                   <num>
##      1:                             18     0.5796018                       1
##      2:                              0     1.9139191                       0
...
##      5:                              0     8.7455471                       0
##     ---                                                                     
## 180494:                              0     1.0000000                       0
## 180495:                              0     1.0000000                       0
## 180496:                              0     1.0000000                       0
## 180497:                              0     1.0000000                       0
## 180498:                              0     1.0000000                       0
##         success_needed_not_di_prop_index success_needed_full_parity_prop_index
##                                    <num>                                 <num>
##      1:                               13                                    26
##      2:                                0                                     0
...
##         di_80_index_reference_group di_80_index di_indicator_80_index
##                              <char>       <num>                 <num>
##      1:             Native American  0.06627393                     1
##      2:             Native American  0.21884498                     1
##      3:             Native American  0.11301989                     1
##      4:             Native American  0.31135531                     1
##      5:             Native American  1.00000000                     0
##     ---                                                              
## 180494:                       - All  1.00000000                     0
## 180495:                       - All  1.00000000                     0
## 180496:                       - All  1.00000000                     0
## 180497:                       - All  1.00000000                     0
## 180498:                       - All  1.00000000                     0
##         success_needed_not_di_80_index success_needed_full_parity_80_index
##                                  <num>                               <num>
##      1:                            266                                 339
##      2:                             64                                  86
...
## 1             Math     Cohort_Math   2017      Ethnicity           Asian 776
## 2             Math     Cohort_Math   2017      Ethnicity           Black 235
## 3             Math     Cohort_Math   2017      Ethnicity        Hispanic 474
## 4             Math     Cohort_Math   2017      Ethnicity Multi-Ethnicity 117
## 5             Math     Cohort_Math   2017      Ethnicity Native American  30
## 6             Math     Cohort_Math   2017      Ethnicity           White 823
##   success        pct ppg_reference ppg_reference_group        moe       pct_lo
## 1      24 0.03092784    0.05336049             overall 0.03517995 -0.004252115
## 2      24 0.10212766    0.05336049             overall 0.06392815  0.038199508
## 3      25 0.05274262    0.05336049             overall 0.04501289  0.007729725
## 4      17 0.14529915    0.05336049             overall 0.09060103  0.054698113
## 5      14 0.46666667    0.05336049             overall 0.17892270  0.287743965
## 6      27 0.03280680    0.05336049             overall 0.03416065 -0.001353848
##       pct_hi di_indicator_ppg success_needed_not_di_ppg
## 1 0.06610778                0                         0
## 2 0.16605581                0                         0
## 3 0.09775551                0                         0
...
## 4             Native American  0.31135531                     1
## 5             Native American  1.00000000                     0
## 6             Native American  0.07030030                     1
##   success_needed_not_di_80_index success_needed_full_parity_80_index
## 1                            266                                 339
## 2                             64                                  86
## 3                            152                                 197
...
For users not familiar with `data.table`, it is better to convert the results to a traditional data frame using `as.data.frame` for further manipulations or export.
...
1. It allows the user to operate on tables that are too large to be ingested into R.
2. It off-loads the computations onto the database engine (so calculations are not leveraging the user's system's resources).

Let's illustrate this with a [SQLite](https://www.sqlite.org/) database:
...
```
##   success_variable cohort_variable cohort disaggregation           group      n
## 1             Math     Cohort_Math 2017.0      Ethnicity           Asian 281200
## 2             Math     Cohort_Math 2017.0      Ethnicity           Black  84200
## 3             Math     Cohort_Math 2017.0      Ethnicity        Hispanic 163000
## 4             Math     Cohort_Math 2017.0      Ethnicity Multi-Ethnicity  42200
## 5             Math     Cohort_Math 2017.0      Ethnicity Native American   9000
## 6             Math     Cohort_Math 2017.0      Ethnicity           White 300000
##   success       pct ppg_reference ppg_reference_group  moe    pct_lo    pct_hi
## 1  252200 0.8968706     0.8462938             overall 0.03 0.8668706 0.9268706
## 2   66200 0.7862233     0.8462938             overall 0.03 0.7562233 0.8162233
## 3  119400 0.7325153     0.8462938             overall 0.03 0.7025153 0.7625153
## 4   35000 0.8293839     0.8462938             overall 0.03 0.7993839 0.8593839
## 5    8400 0.9333333     0.8462938             overall 0.03 0.9033333 0.9633333
## 6  263200 0.8773333     0.8462938             overall 0.03 0.8473333 0.9073333
...
## 6     1.0366771                       0                                0
##   success_needed_full_parity_prop_index di_80_index_reference_group di_80_index
## 1                                     0             Native American   0.9609327
## 2                                  5594             Native American   0.8423821
## 3                                 22765             Native American   0.7848379
## 4                                   750             Native American   0.8886256
## 5                                     0             Native American   1.0000000
## 6                                     0             Native American   0.9400000
##   di_indicator_80_index success_needed_not_di_80_index
## 1                     0                              0
## 2                     0                              0
## 3                     1                           2307
...
```r
# Generate a list of queries for user to run on own
...
## create table DisImpact_Staging_52858 as
## with
## tb_summ as
## (
##   select
...
##       when 'overall' = 'hpg' then 'overall' -- like di_iterate
...
##       when 'hpg' in ('overall', 'all but current') then 'overall'
...
```
## [1] "C:\\Users\\VNGUYE~1\\AppData\\Local\\Temp\\RtmpE92FFC\\student_equity_big_1ddf4cbc5f06.parquet"
```
...
## 1 College 1 Deg/Transfer First-time College             Math     Cohort_Math
## 2 College 1 Deg/Transfer First-time College             Math     Cohort_Math
## 3 College 1 Deg/Transfer First-time College             Math     Cohort_Math
## 4 College 1 Deg/Transfer First-time College             Math     Cohort_Math
## 5 College 1 Deg/Transfer First-time College             Math     Cohort_Math
## 6 College 1 Deg/Transfer First-time College             Math     Cohort_Math
##   cohort disaggregation           group   n success       pct ppg_reference
## 1 2017.0      Ethnicity Native American  30      28 0.9333333     0.8427699
## 2 2017.0      Ethnicity Multi-Ethnicity 117      99 0.8461538     0.8427699
## 3 2018.0      Ethnicity Multi-Ethnicity 204     158 0.7745098     0.8410306
## 4 2018.0      Ethnicity           Black 374     269 0.7192513     0.8410306
## 5 2017.0      Ethnicity           Black 235     185 0.7872340     0.8427699
## 6 2018.0      Ethnicity Native American  32      23 0.7187500     0.8410306
##   ppg_reference_group        moe    pct_lo    pct_hi di_indicator_ppg
## 1             overall 0.17892270 0.7544106 1.1122560                0
## 2             overall 0.09060103 0.7555528 0.9367549                0
## 3             overall 0.06861372 0.7058961 0.8431235                0
## 4             overall 0.05067459 0.6685767 0.7699259                1
## 5             overall 0.06392815 0.7233059 0.8511622                0
## 6             overall 0.17324116 0.5455088 0.8919912                0
##   success_needed_not_di_ppg success_needed_full_parity_ppg di_prop_index
## 1                         0                              0     1.1074593
## 2                         0                              0     1.0040153
## 3                         0                             14     0.9209056
...
## 6                       0                                0
##   success_needed_full_parity_prop_index di_80_index_reference_group di_80_index
## 1                                     0             Native American   1.0000000
## 2                                     0             Native American   0.9065934
## 3                                    15                       Asian   0.8442492
## 4                                    51                       Asian   0.7840151
## 5                                    15             Native American   0.8434650
## 6                                     4                       Asian   0.7834686
##   di_indicator_80_index success_needed_not_di_80_index
## 1                     0                              0
## 2                     0                              0
...
##  [1] data.table_1.14.3    fstcore_0.9.12       scales_1.1.1        
##  [4] forcats_0.5.0        ggplot2_3.3.2        knitr_1.39          
##  [7] arrow_8.0.0          duckdb_0.5.0         RSQLite_2.2.12      
## [10] DBI_1.1.0            dplyr_1.0.8          DisImpact_0.0.9000  
## [13] RevoUtils_11.0.2     RevoUtilsMath_11.0.0
## 
## loaded via a namespace (and not attached):
##  [1] Rcpp_1.0.8.3     highr_0.9        pillar_1.7.0     compiler_4.0.2  
##  [5] sets_1.0-21      tools_4.0.2      digest_0.6.25    bit_1.1-15.2    
##  [9] gtable_0.3.0     evaluate_0.15    memoise_2.0.1    lifecycle_1.0.1 
## [13] tibble_3.1.6     pkgconfig_2.0.3  rlang_1.0.1      cli_3.2.0       
## [17] parallel_4.0.2   xfun_0.30        fastmap_1.1.0    withr_2.5.0     
## [21] stringr_1.4.0    generics_0.1.2   vctrs_0.3.8      grid_4.0.2      
## [25] bit64_0.9-7      tidyselect_1.1.2 glue_1.6.1       R6_2.3.0        
## [29] fansi_1.0.2      farver_2.0.3     purrr_0.3.4      tidyr_1.2.0     
## [33] blob_1.2.1       magrittr_2.0.2   ellipsis_0.3.2   fst_0.9.8       
## [37] assertthat_0.2.1 colorspace_1.4-1 collapse_1.8.8   labeling_0.3    
## [41] utf8_1.2.2       stringi_1.4.6    munsell_0.5.0    cachem_1.0.6    
## [45] crayon_1.5.0
```
