...
2. call a single function to pre-calculate success rates and disprportionate impact across all levels of disaggregation, cohorts, and scenarios;
...
Also note `di_iterate` also returns non-disaggregated results by default (`'- None'` scenario):
```{r}
