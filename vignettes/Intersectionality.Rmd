...
if (run_plots) {
  ...
  ggsave('Intersectionality_Dashboard_1.png', height=5, width=9)
  ...
  ggsave('Intersectionality_Dashboard_2.png', height=5, width=9)
  ...
  ggsave('Intersectionality_Dashboard_3.png', height=5, width=9)
}
```
![Intersectionality Dashboard Viz 1: Disaggregated by Ethnicity.](./Intersectionality_Dashboard_1.png){width=100%}
![Intersectionality Dashboard Viz 2: Disaggregated by Gender.](./Intersectionality_Dashboard_2.png){width=100%}
![Intersectionality Dashboard Viz 3: Disaggregated by Ethnicity + Gender.](./Intersectionality_Dashboard_3.png){width=100%}
